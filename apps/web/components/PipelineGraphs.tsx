  ...
  lanes: [
    ...
    },
    {
      ...
      nodes: [
        ...
        {
          title: "Arbiter + CompositionReviewer",
          kind: "deterministic + LLM",
          detail: "Arbiter closes pending negotiation; the final reviewer checks fidelity, roster balance, form, and obvious quality failures before render projections for MIDI/MusicXML, tabs, piano keys, and piano roll.",
          meta: "one bounded revision pass",
        },
      ],
    },
  ],
  ...
  lanes: [
    ...
    },
    {
      ...
      nodes: [
        ...
        {
          title: "Arbiter -> Reviewer",
          kind: "LangGraph + application",
          detail: "Arbiter resolves pending requests; CompositionReviewer validates the final SongState and can request one targeted revision before render projections for tabs, piano keys, and piano roll.",
        },
      ],
    },
    {
