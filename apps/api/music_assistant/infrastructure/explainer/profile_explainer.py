...
class ProfileExplainer:
    ...
    def _answer_chords(self, profile: ReferenceProfile, audio: MusicProfile) -> ExplanationAnswer:
    ...
    def _answer_tempo(self, profile: ReferenceProfile, audio: MusicProfile) -> ExplanationAnswer:
    ...
    def _answer_key(self, profile: ReferenceProfile, audio: MusicProfile) -> ExplanationAnswer:
        if not audio.key:
            return ExplanationAnswer(
                reference_id=profile.reference_id,
    ...
    def _answer_sections(self, profile: ReferenceProfile, audio: MusicProfile) -> ExplanationAnswer:
    ...
    def _answer_summary(self, profile: ReferenceProfile, audio: MusicProfile) -> ExplanationAnswer:
        rows: list[str] = []
        evidence: list[str] = []
