    ...
    def fuse_connector_results(
        ...
        return SongKnowledgeProfile(
            ...
            identity=SongIdentity(
                title=query.title,
                artist=query.artist,
                primary_artists=query.primary_artists,
                featured_artists=query.featured_artists,
                collaborating_artists=query.collaborating_artists,
                producers=query.producers,
                remix_artist=query.remix_artist,
                alternate_titles=query.alternate_titles,
                album=query.album,
                year=query.year,
                version=query.version,
                candidate_matches=query.candidate_matches,
            ),
