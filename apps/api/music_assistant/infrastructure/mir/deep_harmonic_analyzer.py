...
from music_assistant.infrastructure.mir.bar_energy import per_bar_energy, per_stem_activity_by_bar
from music_assistant.infrastructure.mir.bar_phase import select_bar_phase_offset
...
def _summarize(audio: MusicProfile) -> str:
